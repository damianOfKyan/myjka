  ...
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('contractors')">
        <icon name="office" class="w-4 h-4 mr-2" :class="isUrl('contractors') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('contractors') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Contractors</div>
      </inertia-link>
    </div>
    <div class="mb-4">
